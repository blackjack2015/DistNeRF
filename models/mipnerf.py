...
from models.ray_utils import Rays, sample_along_rays, resample_along_rays, volumetric_rendering, namedtuple_map
from models.pose_utils import to8b
...
class MipNeRF(nn.Module):
    ...
    def render(self, rays, height, width, chunks=8192):
        """
